...
const FAQSection: React.FC = () => {
  ...
  return (
    <section className="relative flex flex-col items-center justify-center min-h-screen overflow-hidden py-96">
      ...
      <motion.div
        className="relative z-10 w-full max-w-5xl px-4 -mt-20"
          ...
          <div className="space-y-0">
            {faqs.map((faq, index) => (
              <motion.div
                ...
                whileInView="visible"
                viewport={{ once: true }}
                className={`bg-purple-600 bg-opacity-80 backdrop-blur-md p-2 border border-white/100 text-left ${
              ...
              >
                ...
                <motion.div
                  ...
                  className={`overflow-hidden leading-relaxed text-gray-200 mt-3 font-semibold ${
