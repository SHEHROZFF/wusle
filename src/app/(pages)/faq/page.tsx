  ...
  return (
    <section className="relative flex flex-col items-center justify-center min-h-screen overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute inset-0 bg-gradient-to-bl from-[#421b76cc] via-[#592d8dcc] to-[#ffc0cb44] mix-blend-multiply" />
      ...
      <div className="w-full relative">
        <svg
          className="w-full h-40 text-purple-400 fill-current"
